...
<body>
    ...
    <h2 class="title1">Онлайн тестирование</h2>
        <div class="row">
            <div class="col-md-3">
                <a href="./test.php" class="btn btn-primary btn-block">Онлайн тест №1</a>
            </div>
            <div class="col-md-3">
                <a href="./test2.php" class="btn btn-primary btn-block">Онлайн тест №2</a>
            </div>
            <div class="col-md-3">
                <a href="#" class="btn btn-primary btn-block">Онлайн тест №3</a>
            </div>
            <div class="col-md-3">
                <a href="#" class="btn btn-primary btn-block">Онлайн тест №4</a>
            </div>
        </div>
    </div>

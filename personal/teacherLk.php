...
<body>
        ...
        <div class="container">
            <div class="nav-row">
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-list__item"><a href="./resultMenu.php" class="nav-list__link">Результаты тестирования</a></li>
    ...
    <main class="section">
        <div class="container">
            <h2 class="title1">Личный кабинет преподавателя</h2>
            <ul class="projects">
                <li class="project">
                    <img src="./img/facts/7.jpg" alt="Project img" class="project__img">
                    <h1 class="project__title"><a href="./editor.php">Создание и редактирование тестов</a></h1>
                </li>
                <li class="project">
